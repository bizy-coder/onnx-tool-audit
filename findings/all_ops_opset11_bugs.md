...
**Summary**: 56 distinct onnx_tool bugs (3081 surface findings collapsed).
...
- **Affected ops** (55): `Abs@11`, `Add@11`, `And@11`, `Atan@11`, `Cast@11`, `Ceil@11`, `Clip@11`, `Constant@11`, `Conv@11`, `ConvInteger@11`, `Cos@11`, `DequantizeLinear@11`, `Dropout@11`, `Elu@11`, `Equal@11`, `Erf@11`, `Exp@11`, `Floor@11`, `Greater@11`, `HardSigmoid@11`, `Identity@11`, `LeakyRelu@11`, `Less@11`, `Log@11`, `MatMulInteger@11`, `Max@11`, `Min@11`, `Mul@11`, `Neg@11`, `Not@11`, `Or@11`, `PRelu@11`, `Pow@11`, `QuantizeLinear@11`, `RandomNormalLike@11`, `RandomUniformLike@11`, `Reciprocal@11`, `ReduceL2@11`, `ReduceMax@11`, `ReduceMean@11`, `ReduceMin@11`, `ReduceProd@11`, `ReduceSum@11`, `Relu@11`, `Sigmoid@11`, `Sign@11`, `Sin@11`, `Softplus@11`, `Sqrt@11`, `Squeeze@11`, `Sub@11`, `Sum@11`, `Tanh@11`, `Transpose@11`, `Xor@11`
- **Surface findings collapsed**: 490
- **Minimal repro**:
...
- **Affected ops** (1): `RandomNormal@11`
...
- **Affected ops** (1): `RandomUniform@11`
- **Surface findings collapsed**: 85
- **Minimal repro**:
...
- **Surface findings collapsed**: 64
- **Minimal repro**:

  Op: `MaxPool`  
  Inputs: `X(input)=B-C-1-1/float16/alternating {'kernel_shape': [1, 1], 'storage_order': 0} outputs=11`  
  Attrs: `{'kernel_shape': [1, 1], 'storage_order': 0}`  
...
- **Minimal repro**:
  ...
  Op: `ArgMin`  
  Inputs: `data(input)=B-C-1-1/float16/random {'axis': 1} outputs=1`  
  Attrs: `{'axis': 1}`  
...
- **Minimal repro**:
  ...
  Op: `Pow`  
  Inputs: `X(input)=B-C-1-1/float16/random Y(input)=B-1-H-1/float16/random  outputs=1`  
...
- **Affected ops** (1): `SpaceToDepth@11`
- **Surface findings collapsed**: 14
- **Minimal repro**:
