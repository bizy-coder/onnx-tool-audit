...
**Summary**: 59 distinct onnx_tool bugs (3263 surface findings collapsed).
...
- **Affected ops** (57): `Abs@12`, `Add@12`, `And@12`, `Atan@12`, `Cast@12`, `Ceil@12`, `Clip@12`, `Constant@12`, `Conv@12`, `ConvInteger@12`, `Cos@12`, `DequantizeLinear@12`, `Dropout@12`, `Elu@12`, `Equal@12`, `Erf@12`, `Exp@12`, `Floor@12`, `Greater@12`, `GreaterOrEqual@12`, `HardSigmoid@12`, `Identity@12`, `LeakyRelu@12`, `Less@12`, `LessOrEqual@12`, `Log@12`, `MatMulInteger@12`, `Max@12`, `Min@12`, `Mul@12`, `Neg@12`, `Not@12`, `Or@12`, `PRelu@12`, `Pow@12`, `QuantizeLinear@12`, `RandomNormalLike@12`, `RandomUniformLike@12`, `Reciprocal@12`, `ReduceL2@12`, `ReduceMax@12`, `ReduceMean@12`, `ReduceMin@12`, `ReduceProd@12`, `ReduceSum@12`, `Relu@12`, `Sigmoid@12`, `Sign@12`, `Sin@12`, `Softplus@12`, `Sqrt@12`, `Squeeze@12`, `Sub@12`, `Sum@12`, `Tanh@12`, `Transpose@12`, `Xor@12`
- **Surface findings collapsed**: 520
- **Minimal repro**:
...
- **Affected ops** (1): `BatchNormalization@12`
...
- **Affected ops** (1): `ThresholdedRelu@12`
...
- **Affected ops** (1): `RandomNormal@12`
...
- **Affected ops** (1): `RandomUniform@12`
- **Surface findings collapsed**: 85
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceL1@12`
- **Surface findings collapsed**: 85
- **Minimal repro**:

  Op: `ReduceL1`  
  Inputs: `data(input)=scalar/float16/sparse {'keepdims': 1} outputs=1`  
  Attrs: `{'keepdims': 1}`  
...
- **Affected ops** (1): `ReduceLogSum@12`
- **Surface findings collapsed**: 85
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceLogSumExp@12`
- **Surface findings collapsed**: 85
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceSumSquare@12`
- **Surface findings collapsed**: 85
- **Minimal repro**:
...
- **Affected ops** (1): `GlobalLpPool@12`
...
- **Affected ops** (1): `MeanVarianceNormalization@12`
- **Surface findings collapsed**: 72
- **Minimal repro**:
...
- **Affected ops** (1): `ReverseSequence@12`
- **Surface findings collapsed**: 36
- **Minimal repro**:
...
- **Affected ops** (1): `GlobalMaxPool@12`
...
- **Affected ops** (1): `Split@12`
- **Surface findings collapsed**: 18
- **Minimal repro**:

  Op: `Split`  
  Inputs: `input(input)=B-C-1-1/bool/alternating {'split': [1]} outputs=1`  
  Attrs: `{'split': [1]}`  
...
- **Affected ops** (1): `Squeeze@12`
- **Surface findings collapsed**: 18
- **Minimal repro**:

  Op: `Squeeze`  
  Inputs: `data(input)=B-C-1-1/bool/alternating  outputs=1`  
...
- **Affected ops** (1): `SpaceToDepth@12`
- **Surface findings collapsed**: 14
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceL2@12`
- **Surface findings collapsed**: 14
- **Minimal repro**:

  Op: `ReduceL2`  
  Inputs: `data(input)=scalar/int64/sparse {'keepdims': 1} outputs=1`  
  Attrs: `{'keepdims': 1}`  
...
- **Affected ops** (1): `DynamicQuantizeLinear@12`
- **Surface findings collapsed**: 12
- **Minimal repro**:
