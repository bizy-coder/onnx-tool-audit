...
**Summary**: 59 distinct onnx_tool bugs (3194 surface findings collapsed).
...
- **Affected ops** (56): `Abs@15`, `Add@15`, `And@15`, `Atan@15`, `Cast@15`, `Ceil@15`, `Clip@15`, `Constant@15`, `Conv@15`, `ConvInteger@15`, `Cos@15`, `DequantizeLinear@15`, `Dropout@15`, `Elu@15`, `Equal@15`, `Erf@15`, `Exp@15`, `Floor@15`, `Greater@15`, `GreaterOrEqual@15`, `HardSigmoid@15`, `HardSwish@15`, `Identity@15`, `LeakyRelu@15`, `Less@15`, `LessOrEqual@15`, `Log@15`, `MatMulInteger@15`, `Max@15`, `Min@15`, `Mul@15`, `Neg@15`, `Not@15`, `Or@15`, `PRelu@15`, `Pow@15`, `QuantizeLinear@15`, `RandomNormalLike@15`, `RandomUniformLike@15`, `Reciprocal@15`, `ReduceL2@15`, `ReduceMax@15`, `ReduceMean@15`, `ReduceMin@15`, `ReduceProd@15`, `Relu@15`, `Sigmoid@15`, `Sign@15`, `Sin@15`, `Softplus@15`, `Sqrt@15`, `Sub@15`, `Sum@15`, `Tanh@15`, `Transpose@15`, `Xor@15`
...
- **Affected ops** (1): `ThresholdedRelu@15`
...
- **Affected ops** (1): `RandomNormal@15`
...
- **Affected ops** (1): `RandomUniform@15`
- **Surface findings collapsed**: 85
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceLogSum@15`
- **Surface findings collapsed**: 84
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceLogSumExp@15`
- **Surface findings collapsed**: 84
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceSumSquare@15`
- **Surface findings collapsed**: 84
- **Minimal repro**:
...
- **Affected ops** (1): `GlobalLpPool@15`
...
- **Affected ops** (1): `MeanVarianceNormalization@15`
- **Surface findings collapsed**: 72
- **Minimal repro**:
...
- **Affected ops** (1): `ReverseSequence@15`
- **Surface findings collapsed**: 36
- **Minimal repro**:
...
- **Affected ops** (1): `GlobalMaxPool@15`
...
- **Affected ops** (1): `SpaceToDepth@15`
- **Surface findings collapsed**: 14
- **Minimal repro**:
...
- **Affected ops** (1): `DynamicQuantizeLinear@15`
- **Surface findings collapsed**: 12
- **Minimal repro**:
