...
**Summary**: 69 distinct onnx_tool bugs (3777 surface findings collapsed).
...
- **Affected ops** (53): `Abs@18`, `Add@18`, `And@18`, `Atan@18`, `Cast@18`, `Ceil@18`, `Clip@18`, `Constant@18`, `Conv@18`, `ConvInteger@18`, `Cos@18`, `DequantizeLinear@18`, `Dropout@18`, `Elu@18`, `Equal@18`, `Erf@18`, `Exp@18`, `Floor@18`, `Greater@18`, `GreaterOrEqual@18`, `HardSigmoid@18`, `HardSwish@18`, `Identity@18`, `LayerNormalization@18`, `LeakyRelu@18`, `Less@18`, `LessOrEqual@18`, `Log@18`, `MatMulInteger@18`, `Max@18`, `Min@18`, `Mul@18`, `Neg@18`, `Not@18`, `Or@18`, `PRelu@18`, `Pow@18`, `QuantizeLinear@18`, `RandomNormalLike@18`, `RandomUniformLike@18`, `Reciprocal@18`, `ReduceL2@18`, `Relu@18`, `Sigmoid@18`, `Sign@18`, `Sin@18`, `Softplus@18`, `Sqrt@18`, `Sub@18`, `Sum@18`, `Tanh@18`, `Transpose@18`, `Xor@18`
- **Surface findings collapsed**: 525
- **Minimal repro**:
...
- **Affected ops** (1): `ThresholdedRelu@18`
- **Surface findings collapsed**: 128
- **Minimal repro**:
...
- **Affected ops** (1): `OptionalHasElement@18`
- **Surface findings collapsed**: 119
- **Minimal repro**:
  ...
  _NotImplementedError: this Node OptionalHasElement-OptionalHasElement_0 has no value_infer_

### Bug 10: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `LpPool@18`
...
- **Affected ops** (1): `BitwiseNot@18`
- **Surface findings collapsed**: 96
- **Minimal repro**:

  Op: `BitwiseNot`  
  Inputs: `X(input)=scalar/int16/random  outputs=1`  
  ...
  _NotImplementedError: this Node BitwiseNot-BitwiseNot_0 has no value_infer_

### Bug 12: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `BitShift@18`
...
- **Affected ops** (1): `ReduceLogSumExp@18`
- **Surface findings collapsed**: 87
- **Minimal repro**:
...
- **Affected ops** (1): `RandomNormal@18`
...
- **Affected ops** (1): `RandomUniform@18`
- **Surface findings collapsed**: 85
- **Minimal repro**:
...
- **Affected ops** (1): `LayerNormalization@18`
- **Surface findings collapsed**: 81
- **Minimal repro**:

  Op: `LayerNormalization`  
  Inputs: `X(input)=B-C-1-1/float64/alternating Scale(input)=B-C-1-1/float64/random {'axis': -1, 'epsilon': 0.5} outputs=110`  
  Attrs: `{'axis': -1, 'epsilon': 0.5}`  

  | what     | shape | dtype | bytes |
  |----------|-------|-------|-------|
  | truth    | `(1, 10, 1, 1)` | `float32` | `40` |
  | onnx_tool| `()` | `float32` | `0` |
...
- **Affected ops** (1): `BitwiseAnd@18`
- **Surface findings collapsed**: 74
- **Minimal repro**:

  Op: `BitwiseAnd`  
  Inputs: `A(input)=scalar/int16/random B(input)=scalar/int16/random  outputs=1`  
  ...
  _NotImplementedError: this Node BitwiseAnd-BitwiseAnd_0 has no value_infer_

### Bug 20: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `BitwiseOr@18`
- **Surface findings collapsed**: 74
- **Minimal repro**:
  ...
  _NotImplementedError: this Node BitwiseOr-BitwiseOr_0 has no value_infer_

### Bug 21: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `BitwiseXor@18`
- **Surface findings collapsed**: 74
- **Minimal repro**:
  ...
  _NotImplementedError: this Node BitwiseXor-BitwiseXor_0 has no value_infer_

### Bug 22: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `GlobalLpPool@18`
...
- **Affected ops** (1): `ReduceL1@18`
- **Surface findings collapsed**: 65
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceLogSum@18`
- **Surface findings collapsed**: 65
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceSumSquare@18`
- **Surface findings collapsed**: 65
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceL2@18`
- **Surface findings collapsed**: 57
- **Minimal repro**:

  Op: `ReduceL2`  
  Inputs: `data(input)=BCHW/float32/sparse {'keepdims': 1, 'noop_with_empty_axes': 1} outputs=1`  
  Attrs: `{'keepdims': 1, 'noop_with_empty_axes': 1}`  

  | what     | shape | dtype | bytes |
  |----------|-------|-------|-------|
  | truth    | `(1, 10, 30, 30)` | `float32` | `36000` |
  | onnx_tool| `(1, 1, 1, 1)` | `float32` | `4` |

  _truth=(1, 10, 30, 30) claim=(1, 1, 1, 1)_

### Bug 28: `wrong-shape`

_onnx_tool's static shape inference disagrees with the runtime shape produced by ORT execution._

- **Affected ops** (1): `MaxPool@18`
...
- **Affected ops** (1): `MeanVarianceNormalization@18`
- **Surface findings collapsed**: 36
- **Minimal repro**:
...
- **Minimal repro**:
  ...
  _NotImplementedError: this Node Mish-Mish_0 has no value_infer_

### Bug 34: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `ReverseSequence@18`
- **Surface findings collapsed**: 36
- **Minimal repro**:
...
- **Affected ops** (1): `GlobalMaxPool@18`
...
### Bug 51: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `SpaceToDepth@18`
- **Surface findings collapsed**: 14
- **Minimal repro**:
...
### Bug 52: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `Det@18`
...
- **Affected ops** (1): `DynamicQuantizeLinear@18`
- **Surface findings collapsed**: 12
- **Minimal repro**:
...
- **Affected ops** (1): `OptionalGetElement@18`
- **Surface findings collapsed**: 12
- **Minimal repro**:

  Op: `OptionalGetElement`  
  Inputs: `input(input)=scalar/bool/random  outputs=1`  
  ...
  _NotImplementedError: this Node OptionalGetElement-OptionalGetElement_0 has no value_infer_

### Bug 55: `wrong-dtype`

_onnx_tool's claimed output dtype disagrees with what ORT produces at runtime._

- **Affected ops** (1): `Round@18`
- **Surface findings collapsed**: 12
- **Minimal repro**:
...
### Bug 60: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `CenterCropPad@18`
- **Surface findings collapsed**: 10
- **Minimal repro**:

  Op: `CenterCropPad`  
  Inputs: `input_data(input)=BCHW/bool/sparse shape(input)=scalar/int64/alternating {'axes': [2, 3]} outputs=1`  
  Attrs: `{'axes': [2, 3]}`  
  ...
  _NotImplementedError: this Node CenterCropPad-CenterCropPad_0 has no value_infer_

### Bug 61: `onnx-tool-fails-valid-model`
...
- **Minimal repro**:
  ...
  Op: `OptionalHasElement`  
  Inputs: `input(init)=B-C-1-1/uint32/random  outputs=1`  
  ...
  _ValueError: cannot reshape array of size 5 into shape (1,10,1,1)_

### Bug 62: `wrong-shape`

_onnx_tool's static shape inference disagrees with the runtime shape produced by ORT execution._

- **Affected ops** (1): `PRelu@18`
...
### Bug 67: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `Split@18`
- **Surface findings collapsed**: 3
- **Minimal repro**:

  Op: `Split`  
  Inputs: `input(input)=BCHW/int16/alternating {'num_outputs': 1} outputs=1`  
  Attrs: `{'num_outputs': 1}`  

  | what     | shape | dtype | bytes |
  |----------|-------|-------|-------|
  | truth    | `None` | `None` | `18000` |
  | onnx_tool| `None` | `None` | `None` |
...
- **Minimal repro**:
  ...
  Op: `ReduceL2`  
  Inputs: `data(input)=BCHW/int64/alternating {'keepdims': 1} outputs=1`  
  Attrs: `{'keepdims': 1}`  

  | what     | shape | dtype | bytes |
  |----------|-------|-------|-------|
  | truth    | `(1, 1, 1, 1)` | `int64` | `8` |
  | onnx_tool| `(1, 1, 1, 1)` | `float64` | `8` |
