...
**Summary**: 60 distinct onnx_tool bugs (3299 surface findings collapsed).
...
- **Affected ops** (57): `Abs@17`, `Add@17`, `And@17`, `Atan@17`, `Cast@17`, `Ceil@17`, `Clip@17`, `Constant@17`, `Conv@17`, `ConvInteger@17`, `Cos@17`, `DequantizeLinear@17`, `Dropout@17`, `Elu@17`, `Equal@17`, `Erf@17`, `Exp@17`, `Floor@17`, `Greater@17`, `GreaterOrEqual@17`, `HardSigmoid@17`, `HardSwish@17`, `Identity@17`, `LayerNormalization@17`, `LeakyRelu@17`, `Less@17`, `LessOrEqual@17`, `Log@17`, `MatMulInteger@17`, `Max@17`, `Min@17`, `Mul@17`, `Neg@17`, `Not@17`, `Or@17`, `PRelu@17`, `Pow@17`, `QuantizeLinear@17`, `RandomNormalLike@17`, `RandomUniformLike@17`, `Reciprocal@17`, `ReduceL2@17`, `ReduceMax@17`, `ReduceMean@17`, `ReduceMin@17`, `ReduceProd@17`, `Relu@17`, `Sigmoid@17`, `Sign@17`, `Sin@17`, `Softplus@17`, `Sqrt@17`, `Sub@17`, `Sum@17`, `Tanh@17`, `Transpose@17`, `Xor@17`
- **Surface findings collapsed**: 541
- **Minimal repro**:
...
- **Affected ops** (1): `ThresholdedRelu@17`
...
- **Affected ops** (1): `RandomNormal@17`
...
- **Affected ops** (1): `RandomUniform@17`
- **Surface findings collapsed**: 85
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceLogSum@17`
- **Surface findings collapsed**: 84
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceLogSumExp@17`
- **Surface findings collapsed**: 84
- **Minimal repro**:
...
- **Affected ops** (1): `ReduceSumSquare@17`
- **Surface findings collapsed**: 84
- **Minimal repro**:
...
- **Affected ops** (1): `LayerNormalization@17`
...
- **Affected ops** (1): `GlobalLpPool@17`
...
- **Affected ops** (1): `MeanVarianceNormalization@17`
- **Surface findings collapsed**: 72
- **Minimal repro**:
...
- **Affected ops** (1): `ReverseSequence@17`
- **Surface findings collapsed**: 36
- **Minimal repro**:
...
- **Affected ops** (1): `GlobalMaxPool@17`
...
- **Affected ops** (1): `SpaceToDepth@17`
- **Surface findings collapsed**: 14
- **Minimal repro**:
...
- **Affected ops** (1): `DynamicQuantizeLinear@17`
- **Surface findings collapsed**: 12
- **Minimal repro**:
...
### Bug 56: `onnx-tool-fails-valid-model`

_onnx_tool throws when profiling a model the ONNX spec checker AND ORT both accept. Either onnx_tool's op coverage is incomplete or it has a bug in shape/value inference._

- **Affected ops** (1): `Split@17`
